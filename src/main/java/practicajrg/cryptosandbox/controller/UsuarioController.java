...
public class UsuarioController {
    ...
    List<String> info() {
        ...
        if (authentication.getPrincipal() instanceof OAuth2User) {
            userInfo = new ArrayList<>(Arrays.asList((userService.findByEmail(((OAuth2User) authentication.getPrincipal()).getAttribute("name"))).getUsername(), ((OAuth2User) authentication.getPrincipal()).getAttribute("email")));
        }else {
